...
function StreamerListItem({
	...
	return (
		<li className="grid w-full grid-cols-3 gap-4 px-2 py-4 text-lg transition-colors sm:text-xl sm:px-4 lg:px-8 hover:bg-gray-700">
			<Link
			...
			<div className="flex items-center gap-2 place-self-end">
				<button
					className="p-1 transition-colors rounded-lg hover:bg-purple-600"
					onClick={() => {
				...
				<div className="min-w-[2ch] text-center">{streamer.votes}</div>
				<button
					className="p-1 transition-colors rounded-lg hover:bg-orange-400"
					onClick={() => {
